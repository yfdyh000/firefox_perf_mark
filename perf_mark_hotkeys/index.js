...
sp.on("pm3", onPrefChange_enable_pm3);
sp.on("pm4", onPrefChange_enable_pm4);
sp.on("pm5", onPrefChange_enable_pm5);
sp.on("pm6", onPrefChange_enable_pm6);
sp.on("pm7", onPrefChange_enable_pm7);
sp.on("pm8", onPrefChange_enable_pm8);
sp.on("pm9", onPrefChange_enable_pm9);
sp.on("pm0", onPrefChange_enable_pm0);
